...
pub async fn find_by_id(pool: web::Data<PgPool>, id: web::Path<i32>) -> HttpResponse {
...
pub async fn update(pool: web::Data<PgPool>, id: web::Path<i32>, user: web::Json<User>) -> HttpResponse {
